    ...
    if (TheText)
    {
        ...
        if (NewTxtLen>0)
        {
            ...
            if (m_TxtLimit>0)
            {
                ...
                SendDlgItemMessage( m_hDlg, m_ControlID,EM_SETSEL, TxtLength,TxtLength);
...
//////////////////////////////////////////////////////////////////////////////////
bool DlgTxtControl::HighlightTxt(int nStart,int nEnd)
{
    SendDlgItemMessage( m_hDlg, m_ControlID, EM_SETSEL, nStart, nEnd);
    SetFocus( GetDlgItem( m_hDlg, m_ControlID ) );
    return (TRUE);
}
//////////////////////////////////////////////////////////////////////////////////
